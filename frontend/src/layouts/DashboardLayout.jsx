...
const DashboardLayout = () => {
  ...
  const theme = {
    mainBg: isAdmin ? 'bg-[#f6f7fb]' : 'bg-[#F5F3EE]',
    sidebarBg: isAdmin ? 'bg-white border-gray-100 shadow-[2px_0_16px_0_rgba(80,80,120,0.06)]' : 'bg-[#FDFCFA] border-stone-100 shadow-[2px_0_16px_0_rgba(120,100,80,0.06)]',
    logoContainer: isAdmin ? 'bg-indigo-600 shadow-indigo-200' : 'bg-amber-800 shadow-amber-200',
    logoIcon: isAdmin ? 'text-white' : 'text-amber-50',
    portalTitle: isAdmin ? 'text-gray-900' : 'text-stone-700',
    portalSubtitle: isAdmin ? 'text-indigo-500' : 'text-amber-700',
    toggleBtnInfo: isAdmin ? 'bg-white border-gray-200' : 'bg-[#FDFCFA] border-stone-200',
    toggleIcon: isAdmin ? 'text-indigo-500' : 'text-amber-700',
    navItemActive: isAdmin ? 'bg-indigo-50 text-indigo-700' : 'bg-amber-50 text-amber-900',
    navItemInactive: isAdmin ? 'text-gray-500 hover:bg-gray-50 hover:text-gray-800' : 'text-stone-400 hover:bg-stone-50 hover:text-stone-700',
    navIconActive: isAdmin ? 'text-indigo-600' : 'text-amber-800',
    navIconInactive: isAdmin ? 'text-gray-400 group-hover:text-gray-600' : 'text-stone-300 group-hover:text-stone-500',
    userWrapperBorder: isAdmin ? 'border-gray-100' : 'border-stone-100',
    userCardBg: isAdmin ? 'bg-gray-50' : 'bg-amber-50/60 border border-amber-100/80',
    userAvatarWrapper: isAdmin ? 'bg-indigo-100' : 'bg-amber-100',
    userAvatarText: isAdmin ? 'text-indigo-600' : 'text-amber-800',
    userName: isAdmin ? 'text-gray-800' : 'text-stone-700',
    userRoleLabel: isAdmin ? 'text-indigo-500' : 'text-amber-700',
    logoutBtnHover: isAdmin ? 'text-gray-400 hover:text-red-600 hover:bg-red-50' : 'text-stone-400 hover:text-red-500 hover:bg-red-50',
    headerAreaBg: isAdmin ? 'bg-white/80 border-gray-100 shadow-[0_1px_8px_0_rgba(80,80,120,0.06)]' : 'bg-[#FDFCFA]/90 border-stone-100 shadow-[0_1px_8px_0_rgba(120,100,80,0.05)]',
    headerIcon: isAdmin ? 'text-indigo-600' : 'text-amber-700',
    headerTitleText: isAdmin ? 'text-gray-900' : 'text-stone-700',
    headerUserPill: isAdmin ? 'bg-gray-50 border-gray-100' : 'bg-amber-50/70 border-amber-100',
    headerUserAvatarPillBg: isAdmin ? 'bg-indigo-100' : 'bg-amber-100',
    headerUserAvatarPillText: isAdmin ? 'text-indigo-600' : 'text-amber-800',
    headerUserNameText: isAdmin ? 'text-gray-700' : 'text-stone-600',
    headerUserRoleText: isAdmin ? 'text-indigo-400' : 'text-amber-600',
    tooltipBg: isAdmin ? '#1a1a2e' : '#44403c',
    tooltipColor: isAdmin ? '#e2e8f0' : '#e7e5e4',
    activeBarGradient: isAdmin ? 'linear-gradient(to bottom, #6366f1, #818cf8)' : 'linear-gradient(to bottom, #92400e, #b45309)',
    toggleBtnHoverBg: isAdmin ? '#ede9fe' : '#fef3c7',
    toggleBtnHoverShadow: isAdmin ? '#ede9fe44' : '#fef3c744',
  };
