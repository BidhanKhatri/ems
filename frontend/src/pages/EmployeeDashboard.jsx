  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Check-In Card */}
        <div className="bg-white p-5 sm:p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col items-center justify-center text-center">
          <div className="flex flex-row items-center gap-3 mb-5 sm:flex-col sm:mb-4">
            <div className="w-10 h-10 sm:w-16 sm:h-16 bg-indigo-100 text-indigo-800 rounded-full flex items-center justify-center shadow-inner border border-indigo-200/50">
              <Clock className="w-5 h-5 sm:w-8 sm:h-8" />
            </div>
            <h3 className="text-lg sm:text-xl font-black text-gray-800 tracking-tight">Attendance Management</h3>
          </div>
          ...
          <div className="px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <h3 className="text-base font-bold text-gray-800 flex items-center gap-2">
                <Trophy className="w-4 h-4 text-indigo-600" /> Team Leaderboard
              </h3>
              <p className="text-xs text-gray-400 mt-0.5">Employees shown anonymously for privacy.</p>
            </div>
            {selfRank && (
              <div className="flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded-xl px-3 py-2 flex-shrink-0">
                <Crown className="w-3.5 h-3.5 text-indigo-600" />
                <div>
                  <p className="text-[9px] uppercase tracking-wider text-indigo-600 font-bold">Your Rank</p>
                  <p className="text-base font-extrabold text-indigo-700 leading-tight">#{selfRank}</p>
                </div>
                <div className="w-px h-7 bg-indigo-200 mx-1" />
                <div>
                  <p className="text-[9px] uppercase tracking-wider text-indigo-600 font-bold">Score</p>
                  <p className="text-base font-extrabold text-indigo-700 leading-tight">{user?.performanceScore ?? 0}</p>
                </div>
              </div>
            )}
          </div>
