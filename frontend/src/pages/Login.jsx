...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 to-purple-100 p-4">
      <div className="w-full max-w-5xl bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden flex h-140">
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-1/2 p-10 bg-white/30">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mb-6">Sign in with email</h2>
          ...
          <form className="w-full space-y-4" onSubmit={handleSubmit}>
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/80 text-base md:text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent transition"
            />
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/80 text-base md:text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent transition pr-10"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-semibold transition-colors disabled:opacity-50"
            >
          ...
          <p className="mt-6 text-sm text-gray-500">
            ...
            <Link to="/register" className="text-indigo-500 hover:text-indigo-700 font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </div>
